    ...
    <div class="box">
            ...
            <div class="box-content" >
                ...
                <div class="box-list box-list-small">
                    ...
                    <div class="box-list-item input-item">
                        <input type="text" name="revenueOrigin" >
                    </div>
                </div>
                ...
                <div class="box-list box-list-small">
                    ...
                    <div class="box-list-item input-item">
                        <input type="number" name="unitValue_Usd" >
                    </div>
                </div>
                <div class="box-list box-list-small">
                    <h5>7.Please enter Unit Value (Local Currency).</h5>
                    <div class="box-list-item input-item">
                        <input type="number" name="unitValue_Local_Currency" >
                    </div>
                </div>

                <div class="box-list box-list-small">
                    <h5>8.Please enter High Cost.</h5>
                    <div class="box-list-item input-item">
                        <input type="number" name="highCost" >
                    </div>
                </div>
                <button class="AddNewRevenue" >Add New Revenue</button>
            </div>
    </div>
</div>
<style>
