<?php
	$info = Socialmedia::getAccountInfo($_POST['account_id']);
?>
        ...
        <div class="box-list float-fade-in">
            <div class="box-list-item">
                <div class="box-container">
                    <h3>Assign Staff Members to <?php echo $info['social_media_account_name']; ?></h3>
                </div>
                    ...
                    <app app-name="staff-list">
                      <staff-list>
                        ...
                        <script type="text/javascript">
                          <?php
                            $getParts = Socialmedia::getAccountParticipants($_POST['account_id']);
                            		...
                            		$('#active-staff').prepend(`<div class="box-list-item">
                                        ...
                                        <div class="box-list box-list-small">
                                            <div class="box-list-item input-item input-select isb-radio">
                                                <ul>
                                                <?php
                                                    $permTitle = array('Remove From Account', 'View Only', 'View And Edit Table Data', 'View And Edit Table Data & Assign Staff To Account');
                                ...
                                echo '<div class="box-list-item">
                                    ...
                                    <div class="box-list box-list-small">
                                        <div class="box-list-item input-item input-select isb-radio">
                                            <ul>';
                                            for ($i = 0; $i < count($permTitle); $i++) {
                                                echo '<li class="input-select-item'.($staff["permission_level"] == $i ? ' active' : '').'">
                                                        <div class="input-select-button"></div>
                                                        <p class="input-select-text">'.$permTitle[$i].'</p>
                                                        <input type="hidden" name="inputval" value="'.$i.'">
                                                    </li>';
                      ...
                      <script type="text/javascript">
                          $(document).ready(function () {
                             $('#updateAssign').click(function () {
                                ...
                                paneljs.fetch({type:'api', call:'projects/assign',postData:{staff:toChange, Accounts_id:<?php echo $_POST['account_id']; ?>}}, (data) => {
